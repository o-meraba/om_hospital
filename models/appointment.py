...
class HospitalAppointment(models.Model):
    ...
    patient_id = fields.Many2one(comodel_name='hospital.patient', string="Patient", ondelete='restrict') # you can use just 'hospital.patient' but it should place first in parentheses
